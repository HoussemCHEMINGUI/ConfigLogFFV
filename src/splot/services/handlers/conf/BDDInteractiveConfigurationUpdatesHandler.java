...
public class BDDInteractiveConfigurationUpdatesHandler extends FreeMarkerHandler {

	protected InteractiveConfigurationElementsProducer confElementProducer = null;

	public BDDInteractiveConfigurationUpdatesHandler(String handlerName, HttpServlet servlet, Configuration configuration, Template template) {
	...
	public void buildModel(HttpServletRequest request, HttpServletResponse response, Map templateModel) throws HandlerExecutionException {
		...
		try {
        	...
        	// Update template list with list of steps
...
//        	}
        	...
        	for( ConfigurationStep confStepObj : stepsToUpdateList ) {
	    		...
	    		for( FeatureTreeNode feature : stepFeatures ) {
	    			...
	    			String featureElementData = confElementProducer.produceFeatureElement(feature, featureData, BDDInteractiveConfigurationMainHandler.featureTemplateFilename);
