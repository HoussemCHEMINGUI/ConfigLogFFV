...
public class FCWSATInteractiveConfigurationMainHandler extends FCWInteractiveConfigurationMainHandler2{

	public static final String featureTemplateFilename = "fcw_interactive_configuration_element_feature.ftl";
	
	public FCWSATInteractiveConfigurationMainHandler(String handlerName, HttpServlet servlet, Configuration configuration, Template template) {
