				...
				<div class="post"> 
					...
					<table style="width:820px; border: 1px solid; border-color: #FF7900; padding: 4; border-spacing: 0px">
						...
						<td align=left valign=top style="width:410px">
							<div style="font-size: 15px; font-weight: bold; padding: 10px">Trek Bikes Features</div>
							<div id="fm">

								<table border=0>

									<tr><td>Bike Category</td>
									<td>
										<select>
										<#list ids.category.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>

									<tr><td>Rider Category</td>
									<td>
										<select>
										<#list ids.rider_category.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.price_range.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>									
									...
									<td>
										<select>
										<#list ids.frame.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>									

									<tr><td>No Suspension</td>
									<td>
										<select>
										<#list ids.without_suspension.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>									
									...
									<td>
										<select>
										<#list ids.front_suspension.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>									
									...
									<td>
										<select>
										<#list ids.rear_suspension.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.wheels_type.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.tires.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.shifters.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									
									<tr><td>Front Derailleur</td>
									<td>
										<select>
										<#list ids.front_derailleur.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									
									<tr><td>Rear Derailleur</td>
									<td>
										<select>
										<#list ids.rear_derailleur.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.crank.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.cassette.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.pedals.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.saddle.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.seat_post.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.handlebars.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.stem.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.headset.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
									...
									<td>
										<select>
										<#list ids.brakeset.children as feature>
											<option id="option_${feature.feature_id}" value="${feature.feature_id}">${formatFeatureName(feature.feature_name)}</option>
										</#list>
										</select>
									</td></tr>
