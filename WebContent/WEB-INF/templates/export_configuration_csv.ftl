...
<body>
    <b><br/>Model Name, Originator Name, Feature ID, Feature Name, Feature Type, Feature Value, Feature Decision Type, Feature Decision Step, TimeStamp</b>
<textarea id="textbox"><#list features as feature> 
${modelName},${OriginatorName1},${feature.id},${feature.name},${feature.type},${feature.value},${feature.decisionType},${feature.decisionStep},${feature.timeStamp}
</#list></textarea>
