...
//	}
	...
	*************************************************************************************************************/
	...
	var viewFileNameInRepository = '${view_file_name!""}';
	var featureModelFileNameInRepository='${feature_model_file_name!""}';
	var relatedFeatureModel='${related_feature_model!""}';
	var xpathValidationResult=0; 
...
***********************************************************************************************************************************************/
	...
	*******************************************************/
	function encodeFeatureModelAsJSONStringToValidation() {


		
		var featureModelJSONString = '{ "feature_model_name" : "' + relatedFeatureModel + '", "feature_diagram" : {';
	...
	/******************************************************
	*  A function to convert a json object to xml 
	*******************************************************/
	...
	/******************************************************
	*  Encode view specification to send it to server 
	*******************************************************/
	function encodeViewSpecificationAsJSONString() {

		/*
		JSON structure for the view specification
 		{	"view_old_name"       : "",
 			"view_new_name"       : "",
 			"view_xpath"          : "",
 			"view_description"    : "",
		...
		*/
		...
		viewJSONString += ' "view_creator" : "' + document.getElementById("view_creator").value + '",';
		viewJSONString += ' "view_email" : "' + document.getElementById("view_email").value + '",';
		viewJSONString += ' "view_date" : "' + document.getElementById("view_creation_date").value + '",';
		viewJSONString += ' "view_comment" : "' + document.getElementById("view_comment").value+'"';
		viewJSONString +="}";

		return viewJSONString;
	}
	...
	*******************************************************/
	function checkXPathValidation(){
	    if (trimAll(document.getElementById("view_xpath").value)==""){
			alert("XPath expression is empty.");
			return;
		}
	...
	*******************************************************/
	       	...
	       	if (oXMLRequest.readyState == 4){
				 if (oXMLRequest.status == 200){
					try{
						  ...
						  document.getElementById("view_errors").value=resultJsonObj.error_list;
						  if ((resultJsonObj.error_list=="") && (!(resultJsonObj.node_list==""))){
						  	xpathValidationResult=1
						  }else{
					 	 ...
					 	 if ((resultJsonObj.error_list=="") && (resultJsonObj.node_list=="")){
					 	 	document.getElementById("view_errors").value="Invalid XPath expression";
					 	 	xpathValidationResult=0;
	...
	/******************************************************
	*  Delete view specification from repository 
	*******************************************************/
	function deleteView(){
			 ...
			 if (oXMLRequest.status == 200){
				try{
					 	 ...
					 	 if (strStatus=="true"){
					 	  ...
					 	  triggerNotificationDialog('', 'View Specification Editor', strStatus);
					 	 }
	...
	*******************************************************/
	...
	/******************************************************
	*  Save view specification to repository 
	*******************************************************/
	function saveViewToRepository() {

		var viewToJSON = encodeViewSpecificationAsJSONString();
		dojo.byId('viewSpecificationJSONString').innerHTML = viewToJSON;
		if ((trimAll(document.getElementById("view_name").value)=="") || (trimAll(document.getElementById("view_name").value)==null)){
			alert("Please enter the view name.");
			document.getElementById("view_name").focus();
			return;
		}
		
		if ((trimAll(document.getElementById("view_xpath").value)=="")|| (trimAll(document.getElementById("view_xpath").value)==null)){
			alert("Please enter the XPath expression.");
			document.getElementById("view_xpath").focus();
			return;
		}
		
		if (xpathValidationResult==0){
			alert("XPath expression is illegal or has not evaluated.");
			document.getElementById("view_xpath").focus();
			return;
		}
		
		
		if ((trimAll(document.getElementById("view_creator").value)=="")|| (trimAll(document.getElementById("view_creator").value)==null)){
			alert("Please enter your name.");
			document.getElementById("view_creator").focus();
			return;
		}
		
		if ((trimAll(document.getElementById("view_email").value)=="")|| (trimAll(document.getElementById("view_email").value)==null)){
			alert("Please enter your Email ID.");
			document.getElementById("view_email").focus();
			
			return;
		}
		
		if (echeck(trimAll(document.getElementById("view_email").value))==false){
			document.getElementById("view_email").focus();
					 	 ...
					 	 if (strStatus=="true"){
					 			 ...
					 			 if (getListSelectedValue(document.getElementById("view_list"))=="New View"){
						 			   ...
						 			   defaultOption.text=document.getElementById("view_name").value;
										 ...
										 try{
											   	viewList.add(defaultOption,null);
						   				 }catch(Error){
						 	 ...
						 	 triggerNotificationDialog('', 'View Specification Editor', "The view has been successfully saved in the repository.");
					 	
					 	 	
					 	 	 
					 	 }else{
					 	  	triggerNotificationDialog('', 'View Specification Editor', strStatus);
							 document.getElementById("view_list").focus();
					 	 }
	...
	*******************************************************/
	...
	function emptyTextEdits(){
		...
		document.getElementById("view_email").value="";
		document.getElementById("view_creation_date").value="";
		document.getElementById("view_comment").value="";
		document.getElementById("view_xpath").value=""; 
		document.getElementById("view_features").value=""; 
		document.getElementById("view_errors").value=""; 
		xpathValidationResult=0;	 
	}
	...
	/******************************************************
	*  Handle XPath validation 
	*******************************************************/
	
	function resetValidation(val){
		alert("dsf");
	}
	...
	/******************************************************
	*  Updates view information whenever a view is selected in View List
	*******************************************************/
		...
		if (oXMLRequest.readyState == 4){
			 if (oXMLRequest.status == 200){
				try{
						  ...
						  if (myJsonObj.viewName!=null)
					     	 document.getElementById("view_name").value=myJsonObj.viewName;
					      else
					      	 document.getElementById("view_name").value="";
					      	 
					      if (myJsonObj.description!=null)
					         document.getElementById("view_description").value=myJsonObj.description;
					      else
					         document.getElementById("view_description").value="";
					         
					      if (myJsonObj.creator!=null)      
						  	 document.getElementById("view_creator").value=myJsonObj.creator;
						  else
						     document.getElementById("view_creator").value="";
						     
						  if (myJsonObj.email!=null)     
						  	 document.getElementById("view_email").value=myJsonObj.email;
						  else
						  	 document.getElementById("view_email").value="";
						  
						  if (myJsonObj.date!=null)
						     document.getElementById("view_creation_date").value=myJsonObj.date;
						  else
						     document.getElementById("view_creation_date").value="";
						     
						  if (myJsonObj.comment!=null)     
						     document.getElementById("view_comment").value=myJsonObj.comment;
						  else
						     document.getElementById("view_comment").value="";
						     
						  if (myJsonObj.specification!=null)       
						  	 document.getElementById("view_xpath").value=myJsonObj.specification; 
						  else
						     document.getElementById("view_xpath").value=""; 	
			...
			<div class="post"> 
				<div  class="entry">
					...
					<table border="0" width="100%">
						...
						<tr><td><span class="hintBox2"><img src="images/important_icon.jpg"/>All information will be lost if you exit this page. Hence, make sure you save your view regularly.</span></td></tr>
					</table>					
				 	...
				 	<tr><td width="60%" align="left" valign="top">
				 		...
				 		<table border=0 width=100% cellpadding=3 cellspacing=5>
							...
							**********************************-->
					 		...
					 		<tr><td class="stylishTitle"><span title="Click to expand/collapse" onclick="expandCollapseElement('view_specification');">View Specification</span></td></tr>
					 		<tr><td>					 			 
								<table border=0 id="view_specification" class="feature_model_edition_table1">
							    <tr>
							      <td align="left" ><label for="view_list">View List: </label></td>
							      <td align="left" >
							      	<select name="view_list" id="view_list" autocomplete="true"  onchange="onchangeViewListSelectedItem()"> 
							     	 	<option>New View</option>
							     	 	<#if view_file_source=="existing_file">
							     	 	<#list views_list as viewlist>
							     	 		<option>${viewlist.view_name}</option>
							     	 	</#list>
							     	 	</#if>
							      	</select>
							    ...
							    <tr>
							      <td align="left" ><label for="view_name">View Name: </label></td>
							      <td align="left" ><input dojoType="dijit.form.TextBox" type="text" name="view_name" id="view_name" value=""/> (*)</td>
							    </tr>
							    <tr>
							      <td align="left" ><label for="view_xpath">XPath Expression: </label></td>
							      <td align="left" ><input dojoType="dijit.form.SimpleTextarea" type="text" name="view_xpath" id="view_xpath" value="" /> (*)</td>
							    </tr>
							    <tr>
						  	 </table>
							...
							**********************************-->
					 		...
					 		<tr><td>					 			 
							    ...
							    <tr>
							      <td align="left" ><label for="view_description">Description: </label></td>
							      <td align="left" ><input dojoType="dijit.form.TextBox" type="text" name="view_description" id="view_description" value=""/></td>
							    </tr>
							    <tr>
							      <td align="left" ><label for="view_creator">Creator: </label></td>
							      <td align="left" ><input dojoType="dijit.form.TextBox" type="text" name="view_creator" id="view_creator" value=""/> (*)</td>
							    </tr>
							    <tr>
							      <td align="left" ><label for="view_email">Creator's Email: </label></td>
							      <td align="left" ><input dojoType="dijit.form.TextBox" type="text" name="view_email" id="view_email" value=""/> (*)</td>
							    </tr>
							 
							    <tr>  
							      <td align="left" ><label for="view_creation_date">Date view was created:</label></td>
							      <td align="left" ><input dojoType="dijit.form.DateTextBox" type="text" name="view_creation_date" id="view_creation_date" value=""/></td>
							    </tr>
							    
							    <tr>
							      <td align="left" ><label for="view_comment">Creator's Comment: </label></td>
							      <td align="left" ><input dojoType="dijit.form.TextBox" type="text" name="view_comment" id="view_comment" value=""/></td>
							    </tr>
					...
					**********************************-->
				 	...
				 	<td width="40%" align="right" valign="top">
						...
						**********************************-->
				 		...
				 		<tr><td class="stylishTitle2"><span title="Click to expand/collapse" onclick="expandCollapseElement('view_log');">View Log</span></td></tr>
				 		<tr><td>

						  	<table  class="feature_model_edition_table1" id="view_log">
						    <tr>
						      <td align="left"><span id="featuresInViewMark"></span></td>
						      <td align="left" title="Lists the features based on view definition">Features</td>

						      <td align="left" ><input dojoType="dijit.form.SimpleTextarea"  rows=3  type="text" name="view_features" id="view_features"  value=""/> (*)</td>
						      
						    </tr>
						    <tr>
						      <td align="left"><span id="errorsInViewDefinitionMark"></span></td>
					...
					<form id="featureModelSendToServerForm" style="display:none">
					  ...
					  <textarea id="viewSpecificationJSONString" name="viewSpecificationJSONString"></textarea>
