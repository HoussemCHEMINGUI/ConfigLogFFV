...
<div class="btm"> 
	<div id="page"> 
		<div id="content"> 
			<div class="post"> 
				<h1 class="title"><a href="#">Workflow Specifications</a></h1> 
				<div class="entry"> 
					 ...
					 <div>
					 	<table border="0" width="100%" cellpadding="10">
						 	<tr><td align="left">
								 <div>
								 <ol dojoType="dojox.widget.SortList" id="workflows"  title="Workflow Specifications" sortable="false" style="width:300px; height=300px;">
								   				<#list workflowlist as workflows >
								   				<#assign workflowname=workflows.workflow_name> 
													<li> ${workflows.workflow_name}  
														<ul>
															<#list workflowlist as workflows>
								   								<#list workflows.tasks as workflowtasks>
								   								   <#if workflows.workflow_name==workflowname>
																		<li> ${workflowtasks.task_name} </li>
																	</#if>
																</#list>
															</#list>
														</ul>
