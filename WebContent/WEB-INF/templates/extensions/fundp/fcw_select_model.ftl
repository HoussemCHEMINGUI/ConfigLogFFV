...
<#else>
	...
	{
		ajax_loadContent('_model_repository','/SPLOT/MultiplePerspectiveConfigurationViewsServlet?action=select_model&enableSelection=${enableSelection?string}&selectionMode=${selectionMode}&serviceURL=${serviceURL}&serviceHTTPMethod=${serviceHTTPMethod}&serviceAction=${serviceAction}&sortby='+sortBy);
	} 
	-->
	</script>
