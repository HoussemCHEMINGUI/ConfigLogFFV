...
<div id="menu"> 
    <ul> 
        ...
        <li class="first"><a href="feature_model_edition.html">Product Line Model Editor</a></li> 
        <li><a href="product_configuration.html">Product Line Configuration</a></li> 
...
<div class="btm"> 
	<div id="page"> 
		<div id="content">
			...
			<tr>
				<td align="center"><img onclick="configureModel()" title="Configure your feature model" style="cursor:pointer;" src="images/1.png" width="60px" height="60px"/> <p>Configure</p></td>
					<td align="center"><img onclick="exportModel()" title="Export your feature model to the SXFM format" style="cursor:pointer;" src="images/2.png" width="60px" height="60px"/> <p>Export</p></td>
					<td align="center"><img onclick="saveModelToRepository()" title="Save your feature model to SPLOT's feature model repository" style="cursor:pointer;" src="images/3.png" width="60" height="60px"/> <p>Save</p>
				</td>
			</tr>
