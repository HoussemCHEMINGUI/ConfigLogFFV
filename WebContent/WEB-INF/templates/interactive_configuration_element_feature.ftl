...
<#if feature_type != "group" && feature_decision == "-1"><img title="Feature yet to be decided" src="/SPLOT/images/load.gif"><#else><img src="/SPLOT/images/known.gif"></#if>${leftHTMLSpaces(feature_level+1)}
<#compress>
